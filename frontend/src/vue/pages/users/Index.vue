...
const crud = useCrud<User>('/api/users', true)
const { 
    records, 
    selectedRecord, 
    fetchingRecords,
        ...
        <template #header>
            ...
            <div class="flex items-center gap-2">
                ...
                <AddNewButton
                    ...
                    @click="openModal(null, UsersForm)"
                />
            </div>
        </template>
                ...
                <table class="min-w-full">
                    <thead class="bg-secondary-background">
                        <tr>
                            ...
                            <TableHead :label="$t('Status')" />
                            <TableHead />
                        </tr>
                    </thead>
                    <tbody>
                        <tr 
                            @click="openModal(record, UsersForm)" 
                        ...
                        >
                            ...
                            <TableCell>{{ record.is_active ? $t('Active') : $t('Inactive') }}</TableCell>
                            <TableCell>
